...
from utils_att import create_input_files
import argparse
import os
...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_path', default="./dataset/caption_dataset/FACAD_170k.json",
    ...
    parser.add_argument('--output_folder', default='./dataset/generated_facad17k30_att', help='output filepath.')
    parser.add_argument('--max_len', type=int, default=25, help='the maximum length of each caption.')
